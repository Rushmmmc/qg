...
import com.zhangmengcong.www.dao.dao.SelectGoodsByInterest;
...
public class SelectGoodsByInterestImpl implements SelectGoodsByInterest {
    ...
    public List<Goods> selectGoodsByInterest(String username) {
        ...
        try {
            ...
            if(emps.isEmpty()){
                String sql4 = "select * from goods where status != ? and status != ? and seller != ? limit 0,3";
                pstmt  = conn.prepareStatement(sql4);
                pstmt.setString(1,"未审核");
                pstmt.setString(2,"已封禁");
