...
import com.zhangmengcong.www.service.service.AdminBanOrUnbanUserService;
...
public class AdminBanOrUnbanUserServiceImpl implements AdminBanOrUnbanUserService {
    ...
    public String adminBanOrUnbanUserService(int ifBan, String username,String banReason){
        ...
        if(ifBan == BAN){
            ...
            //封禁用户所有商品
            factory.getUpdateDao().updateDao("goods","status","'已封禁'","seller",
                    "\""+username+"\"");
            ...
            //解封用户所有商品
            factory.getUpdateDao().updateDao("goods","status","'已审核'","seller",
                    "\""+username+"\"");
