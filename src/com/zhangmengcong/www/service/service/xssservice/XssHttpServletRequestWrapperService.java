package com.zhangmengcong.www.service.service.xssservice;
 ...
 */
public class XssHttpServletRequestWrapperService extends HttpServletRequestWrapper {
    HttpServletRequest orgRequest;

    public XssHttpServletRequestWrapperService(HttpServletRequest request) {
        super(request);
        orgRequest = request;
    }
    /**
